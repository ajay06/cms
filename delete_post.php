...
if(isset($_POST["Submit"])) {
    ...
    if(empty($Title)){
        ...
        Redirect_to("add_new_post.php");
            ...
            $vQuery="DELETE FROM admin_panel 
            ...
            <div class="row">
                    ...
                    <div class="col-sm-10">
                            ...
                            <div >
                                        ...
                                        <form action="delete_post.php?Delete=<?php echo $PostIDFromURL; ?>" method="post" enctype="multipart/form-data">
                                            <fieldset>
                                                ...
                                                <input class="btn btn-success btn-block" style="height:50px"   type="Submit" name="Submit" value="Delete Post">
                                            </fieldset>
